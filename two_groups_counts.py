...
princ_file_normal=open(args.des+args.pgn+"_"+str(kmer_size)+"_all_var"+".wig", "w")
princ_file_normal.write("variableStep chrom="+header+"\n")

other_file_normal=open(args.des+args.ogg+"_"+str(kmer_size)+"_all_var"+".wig", "w")
other_file_normal.write("variableStep chrom="+header+"\n")

diff_file_normal=open(args.des+"diff_"+str(kmer_size)+"_all_var"+".wig", "w")
diff_file_normal.write("variableStep chrom="+header+"\n")

#this files are the ones were the output 
princ_file_mismatch=open(args.des+args.pgn+"_"+str(kmer_size)+"_only_mismatches"+".wig", "w")
princ_file_mismatch.write("variableStep chrom="+header+"\n")

other_file_mismatch=open(args.des+args.ogg+"_"+str(kmer_size)+"_only_mismatches"+".wig", "w")
other_file_mismatch.write("variableStep chrom="+header+"\n")

diff_file_mismatch=open(args.des+"diff_"+str(kmer_size)+"_only_mismatches"+".wig", "w")
